...
namespace MFiles.EntityFramework.PowerShell.Utilities
{
	internal class ObjectClassGenerator
	{
		...
		private void AddConstructors(CodeTypeDeclaration targetClass)
		{
			...
			constructor.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof(Vault), "vault"));
			constructor.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof (ObjectVersion), "versionInfo"));
			constructor.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof(bool), "checkOut"));
			...
			constructor2.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof(ObjectVersionAndProperties), "ovap"));
			constructor2.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof(bool), "checkOut"));
			...
			constructor3.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof(Vault), "vault"));
			constructor3.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof(ObjVer), "objVer"));
			constructor3.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
			...
			constructor4.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof(Vault), "vault"));
			constructor4.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
				typeof(int), "objType"));
			constructor4.BaseConstructorArgs.Add(new CodeParameterDeclarationExpression(
